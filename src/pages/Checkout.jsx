...
export default function Checkout() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      billing: {
        ...
        surname: isBillingSameAsShipping
          ? formData.shipping_surname
          : formData.billing_surname,
        street: isBillingSameAsShipping
          ? formData.shipping_street
          : formData.billing_street,
        city: isBillingSameAsShipping
          ? formData.shipping_city
          : formData.billing_city,
        postcode: isBillingSameAsShipping
          ? formData.shipping_postcode
          : formData.billing_postcode,
        province_state: isBillingSameAsShipping
          ? formData.shipping_province_state
          : formData.billing_province_state,
        country: isBillingSameAsShipping
    ...
    return (
      ...
      >
        <div className=" p-5 ordine-confermato shadow-lg d-inline-block">
          ...
          <h1 className="fw-bold text-uppercase title-order">
            Ordine Confermato!
          </h1>
          <p className="lead opacity-75 text-grazie">
            Grazie per aver scelto la tecnologia Aeterna.
          </p>
          <hr className="border-secondary my-4" />
          <p className="mb-1 text-grazie">
            ID Ordine:{" "}
            <span className="text-gold fw-bold">#{orderData?.ordine_id}</span>
          </p>
          <p className="mb-4 text-grazie">
            Fattura: <span className="text-gold">{orderData?.fattura}</span>
          </p>
          <button
            onClick={() => navigate("/")}
            className="order-btn px-5 py-3 fw-bold"
          >
            TORNA ALLA HOME
          </button>
        </div>
  ...
  return (
    <div
      className="checkout-page text-white min-vh-100"
      ...
      <div className="container pb-5">
        <form onSubmit={handleSubmit} className="row">
          <div className="col-lg-8">
            ...
            <div className="p-4 border-checkout mb-4">
              ...
              <div className="row">
                <div className="col-12 mb-3">
                  <label htmlFor="customer_email" className="px-2">
                    Email:
                  </label>
                  <input
                    type="email"
                ...
                <div className="col-md-6 mb-3">
                  <label htmlFor="shipping_name" className="px-2">
                    Nome:
                  </label>
                  <input
                    type="text"
                ...
                <div className="col-md-6 mb-3">
                  <label htmlFor="shipping_surname" className="px-2">
                    Cognome:
                  </label>
                  <input
                    id="shipping_surname"
                ...
                <div className="col-12 mb-3">
                  <label htmlFor="shipping_street" className="px-2">
                    Indirizzo:
                  </label>
                  <input
                    id="shipping_street"
                ...
                <div className="col-md-4 mb-3">
                  <label htmlFor="shipping_city" className="px-2">
                    Città:
                  </label>
                  <input
                    id="shipping_city"
                ...
                <div className="col-md-4 mb-3">
                  <label htmlFor="shipping_postcode" className="px-2">
                    CAP:
                  </label>
                  <input
                ...
                <div className="col-md-4 mb-3">
                  <label htmlFor="shipping_province_state" className="px-2">
                    Provincia:
                  </label>
                  <input
                    id="shipping_province_state"
                    type="text"
                    name="shipping_province_state"
            ...
            <div className="p-4 border-checkout mb-4">
              ...
              <div className="form-check form-switch mb-3">
                ...
                />
                <label htmlFor="billing-checkbox" className="form-check-label">
                  Usa dati spedizione
                </label>
              </div>
              ...
              <div className="row">
                <div className="col-12">
                  <label
                    ...
                    className="px-2 visually-hidden"
                  >
                    Metodo di Pagamento
                  </label>
                  <select
                  ...
                  <p className="small opacity-50 mt-2 text-center">
          ...
          <div className="col-lg-4">
            <div
              className="p-4 riepilogo sticky-top shadow-lg"
              style={{ top: "140px" }}
            >
              <h4 className="fw-bold mb-4 text-center text-uppercase border-bottom">
                Riepilogo
              </h4>
              <hr />
              <div className="d-flex justify-content-between fs-3 mb-4 ">
                <h4 className="totale anta-font">TOTALE:</h4>
                <span className="totale fw-bold">
                  {(subtotal + shippingCost).toFixed(2)}€
                </span>
              </div>
              <button
                type="submit"
                className="order-btn w-100 py-3 fw-bold text-uppercase shadow"
              >
                ORDINA ORA
              </button>
            </div>
