...
export default function About() {
  // Stati per il finto caricamento e l'animazione (identici a DetailProduct)
  const [loading, setLoading] = useState(true);
  const [fade, setFade] = useState(false);
  const [count, setCount] = useState(0);

  useEffect(() => {
    // Reset iniziale proprio come nel dettaglio prodotto
    setLoading(true);
    setFade(false);
    window.scrollTo(0, 0);

    // Simulazione sincronizzazione dati
    const timer = setTimeout(() => {
      setLoading(false);
      // Attivazione animazione dopo il caricamento
  ...
  // Schermata di caricamento identica a DetailProduct
  if (loading) {
    return (
  ...
  return (
    <>
      {/* Wrapper con le classi per l'effetto fade-in */}
              ...
              <div className="col-lg-8">
                ...
                <div className="d-flex justify-content-center gap-5 mt-4">
                  <div className="text-center">
                    <h3 className="fw-bold text-primary mb-0 display-6">{count}+</h3>
