        ...
        <div className="filters-container bg-dark p-4 rounded-4 border border-secondary mb-5 shadow-lg">
          <div className="row g-4">
            ...
            <div className="col-md-6">
              ...
              <select className="form-select bg-black text-white border-secondary" value={selectedEra} onChange={(e) => setSelectedEra(e.target.value)}>
            ...
            <div className="col-md-4">
              ...
              <select className="form-select bg-black text-white border-secondary" value={selectedDiet} onChange={(e) => setSelectedDiet(e.target.value)}>
            ...
            <div className="col-md-4">
              ...
              <select className="form-select bg-black text-white border-secondary" value={selectedPower} onChange={(e) => setSelectedPower(e.target.value)}>
            ...
            {/* Dimensione */}
            <div className="col-md-4">
              <label className="small text-info mb-2 text-uppercase fw-bold">Taglia (Dimension)</label>
              <select className="form-select bg-black text-white border-secondary" value={dimension} onChange={(e) => setDimension(e.target.value)}>
            ...
            <div className="col-md-6">
              ...
              <input 
                type="range" className="form-range" min="0" max="15000" step="100" 
                value={minPrice} 
